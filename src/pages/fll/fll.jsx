...
import FLLHeaderImage from '../../assets/images/girls-scout-header.png';

import './fll.styles.scss';
import Button from '../../components/button/button.component';
import Header from '../../components/header/header.component';

const FLLPage = () => (
    <div>
        <Header image={FLLHeaderImage}/>
        <div className="competitions-content">
            <div className="container header-text-container">
                <div className="row">
                    <div className="top-header col-sm-12 col-md-6">
                        <div className="text">
                            <h1 className="header-title cw-dark-blue bungee">FLL</h1> 
                ...
                <div className="container competitions-top">
                    <div className="row">
                        <div className="image col-md-6 order-md-1">
                            <img src={CompetitionTech} alt="Tech"/>
                        </div> 
